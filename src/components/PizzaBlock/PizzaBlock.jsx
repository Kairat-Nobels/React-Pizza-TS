        ...
        <div className='pizza-wrapper'>
            <div className="pizza-block">
                ...
                <div className="pizza-block__selector">
                    ...
                    <ul>
                        {sizes.map((size, i) => <li onClick={() => setActiveSize(i)} className={activeSize === i ? 'active' : ''} key={size}> {size}  см.</li>)}
                    </ul>
                </div>
                <div className="pizza-block__bottom">
                    <div className="pizza-block__price">от {price} сом</div>
                    <button onClick={e => { setCount(count + 1) }} className="button button--outline button--add">
