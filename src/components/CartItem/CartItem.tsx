...
import { minusCart, plusCart, removeCart } from '../../redux/cart/slice'
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-count">
                <div onClick={() => dispatch(count > 1 ? minusCart(id) : removeCart(id))} className="button button--outline button--circle cart__item-count-plus">
